...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | OOB_MANAGEMENT | oob | default | 192.168.0.108/24 | 192.168.0.1 |
...
| --------- | --------------- | ------------ | --------- |
| DC1_L3_LEAF3 | Vlan4094 | 10.255.1.72 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_dc1-leaf3a_Ethernet3 | *trunk | *- | *- | *MLAG | 3 |
| Ethernet4 | MLAG_dc1-leaf3a_Ethernet4 | *trunk | *- | *- | *MLAG | 3 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet1 | P2P_dc1-spine1_Ethernet6 | - | 10.255.255.21/31 | default | 1500 | False | - | - |
| Ethernet2 | P2P_dc1-spine2_Ethernet6 | - | 10.255.255.23/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_dc1-leaf3a_Port-Channel3 | trunk | - | - | MLAG | - | - | - | - |
...
| Loopback10 | DIAG_VRF_VRF10 | VRF10 | 10.255.10.8/32 |
| Loopback11 | DIAG_VRF_VRF11 | VRF11 | 10.255.11.8/32 |
...
| Vlan3011 |  VRF12  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |
| Vlan3012 |  hrvrf  |  10.255.1.105/31  |  -  |  -  |  -  |  -  |
...
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | hrvrf | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| 10.255.1.104 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF12 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| --- | ------------------- | ------------ |
| hrvrf | 10.255.0.8:13 | connected |
| VRF10 | 10.255.0.8:10 | connected |
| VRF11 | 10.255.0.8:11 | connected |
| VRF12 | 10.255.0.8:12 | connected |
...
router bgp 65103
   ...
   neighbor MLAG-IPv4-UNDERLAY-PEER description dc1-leaf3a
   ...
   neighbor 10.255.1.104 description dc1-leaf3a_Vlan4093
   ...
   vrf hrvrf
      ...
      router-id 10.255.0.8
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description dc1-leaf3a_Vlan3012
   ...
   vrf VRF10
      ...
      router-id 10.255.0.8
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description dc1-leaf3a_Vlan3009
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF11
      rd 10.255.0.8:11
      ...
      router-id 10.255.0.8
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description dc1-leaf3a_Vlan3010
      redistribute connected route-map RM-CONN-2-BGP-VRFS
   !
   vrf VRF12
      rd 10.255.0.8:12
      ...
      router-id 10.255.0.8
      neighbor 10.255.1.104 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.104 description dc1-leaf3a_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
