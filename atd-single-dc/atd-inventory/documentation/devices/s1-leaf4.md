...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet5 | - | 172.30.255.13/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet5 | - | 172.30.255.15/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.0.255.6/32 |
...
| Tenant_B_OP_Zone | 192.0.255.6:20 | 20:20 | - | - | learned | 210-211 |
...
| Tenant_B_OP_Zone | 192.0.255.6:20 | connected | - |
...
router bgp 65102
   ...
   vrf Tenant_A_OP_Zone
      ...
      neighbor 10.255.251.4 description s1-leaf3_Vlan3009
   ...
   vrf Tenant_B_OP_Zone
      ...
      router-id 192.0.255.6
      neighbor 10.255.251.4 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.4 description s1-leaf3_Vlan3019
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
