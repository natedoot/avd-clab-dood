...
| Ethernet4 | SERVER_s1-host2_Eth1 | *access | *110 | *- | *- | 4 |
...
| --------- | ----------- | ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet2 | P2P_s1-spine1_Ethernet4 | - | 172.30.255.9/31 | default | 1500 | False | - | - |
| Ethernet3 | P2P_s1-spine2_Ethernet4 | - | 172.30.255.11/31 | default | 1500 | False | - | - |
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | ROUTER_ID | default | 192.0.255.5/32 |
| Loopback1 | VXLAN_TUNNEL_SOURCE | default | 192.0.254.5/32 |
| Loopback100 | DIAG_VRF_Tenant_A_OP_Zone | Tenant_A_OP_Zone | 10.255.1.5/32 |
...
| 10.255.251.5 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Tenant_B_OP_Zone | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
| Tenant_B_OP_Zone | 192.0.255.5:20 | 20:20 | - | - | learned | 210-211 |
...
| Tenant_B_OP_Zone | 192.0.255.5:20 | connected | - |
...
router bgp 65102
   ...
   vrf Tenant_A_OP_Zone
      ...
      neighbor 10.255.251.5 description s1-leaf4_Vlan3009
   ...
   vrf Tenant_B_OP_Zone
      ...
      router-id 192.0.255.5
      neighbor 10.255.251.5 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.251.5 description s1-leaf4_Vlan3019
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
