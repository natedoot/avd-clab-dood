...
│       └── interfaces-test.yml
```
## Also working if you redefine user_catalog dir var
  ...
  tasks:
    - name: validate using anta_runner
      ...
      vars:
        ...
        user_catalogs_dir: "{{ anta_dir }}/{{ user_catalogs_dir_name }}/interfaces/"
```

### Play Log

```
/Users/nate.shaw/git_projects/avd-clab-dood/single-dc-lab/avd main                                                                                                           19:21:57
❯ ansible-playbook playbooks/anta-validate.yml -i inventory.yml
...
ok: [dc1-leaf1a -> localhost] => (item=/Users/nate.shaw/git_projects/avd-clab-dood/single-dc-lab/avd/anta)
ok: [dc1-leaf1a -> localhost] => (item=/Users/nate.shaw/git_projects/avd-clab-dood/single-dc-lab/avd/anta/avd_catalogs)
changed: [dc1-leaf1a -> localhost] => (item=/Users/nate.shaw/git_projects/avd-clab-dood/single-dc-lab/avd/anta/user_catalogs/interfaces/)
ok: [dc1-leaf1a -> localhost] => (item=/Users/nate.shaw/git_projects/avd-clab-dood/single-dc-lab/avd/anta/reports)
...
PLAY RECAP ***************************************************************************************************************************************************************************
dc1-leaf1a                 : ok=4    changed=1    unreachable=0    failed=1    skipped=0    rescued=0    ignored=0  
```
