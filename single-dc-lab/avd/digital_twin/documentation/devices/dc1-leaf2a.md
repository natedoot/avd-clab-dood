...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.105/24 | 192.168.0.1 |
...
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 10.255.12.5/32 |
...
ip address virtual source-nat vrf VRF12 address 10.255.12.5
```
