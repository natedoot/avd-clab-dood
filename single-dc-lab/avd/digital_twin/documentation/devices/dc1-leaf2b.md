...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | OOB_MANAGEMENT | oob | default | 192.168.0.106/24 | 192.168.0.1 |
...
| Ethernet5 | SERVER_dc1-leaf2-server1_PCI2 | *trunk | *21-22 | *4092 | *- | 5 |
...
| Loopback12 | DIAG_VRF_VRF12 | VRF12 | 10.255.12.6/32 |
...
| 10.255.1.100 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | VRF12 | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - | - | - | - | - |
...
router bgp 65102
   ...
   vrf VRF10
      ...
      neighbor 192.168.5.6 peer group OVERLAY-EXTERNAL-PEERS
      neighbor 192.168.5.6 remote-as 64512
      neighbor 192.168.5.6 description 9504
   ...
   vrf VRF12
      ...
      router-id 10.255.0.6
      neighbor 10.255.1.100 peer group MLAG-IPv4-UNDERLAY-PEER
      neighbor 10.255.1.100 description dc1-leaf2a_Vlan3011
      redistribute connected route-map RM-CONN-2-BGP-VRFS
```
...
ip address virtual source-nat vrf VRF12 address 10.255.12.6
```
