...
| Ethernet5 | P2P_dc1-leaf3a_Ethernet1 | - | 10.255.255.16/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_dc1-leaf3b_Ethernet1 | - | 10.255.255.20/31 | default | 1500 | False | - | - |
...
router bgp 65100
   ...
   neighbor 10.255.255.17 description dc1-leaf3a_Ethernet1
   neighbor 10.255.255.21 peer group IPv4-UNDERLAY-PEERS
   neighbor 10.255.255.21 remote-as 65103
   neighbor 10.255.255.21 description dc1-leaf3b_Ethernet1
